...
INSERT INTO countries (          name, population,   capital )
			   Values ( 'Albania',	       65, 	 'Tirana' ),
					  (    'Angola',		   35,	'Luanda' ),
                      (       'Armenia',		   54,	'Yerevan' ),                      
					  (      'Australia',		   57, 'Canberra' );
...
INSERT INTO product ( product_name,                                                                                                                      description, supplier_id )
			 VALUES (     'Pen drives',                          'A pen drive is a small self-powered drive that connects to a computer directly through a USB port',         Null ),
                    (          'Mobile',                                  'A mobile phone is a wireless handheld device that allows users to make and receive calls',         Null ),
                    (           'Watch',                                               'A watch is a portable timepiece intended to be carried or worn by a person.',         Null ),
                    (       'Headphone', 'headphones are a hardware output device that connect to a computer line out or speakers port or wirelessly with Bluetooth',        Null );
